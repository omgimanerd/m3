...
def test_hash_asset_dir(current_dir, read_json_file):
    ...
    sha1_hashes = hash_asset_dir(current_dir / 'testdata/mods', 'sha1')
    sha512_hashes = hash_asset_dir(current_dir / 'testdata/mods', 'sha512')
    md5_hashes = hash_asset_dir(current_dir / 'testdata/mods', 'md5')
